...
import { MissionSessionLogWriter } from './MissionSessionLogWriter.js';
...
export class MissionRuntime {
	...
	private readonly sessionLogWriter: MissionSessionLogWriter;
	...
	private constructor(
		...
		this.sessionLogWriter = new MissionSessionLogWriter(this.adapter, this.missionDir, this.descriptor.missionId);
	...
	private syncAgentSessions(document: MissionRuntimeRecord | undefined): void {
		...
		this.sessionLogWriter.reconcile(this.agentSessions);
